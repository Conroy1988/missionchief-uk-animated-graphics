...
- Six-frame APNG loop for the True Scale profile; twelve frames for Modern Command Visibility.
...
- Exactly six APNG frames in True Scale and twelve in Modern Command Visibility.
