...
def build_catalogue() -> dict:
    ...
    build_report = load_json(ROOT / "data/v1.4.9-build-report.json")
    ...
    return {
        ...
        "generated_from": [
            ...
            "data/v1.4.9-build-report.json",
            "data/v1.4.9-scope.json",
            "data/v1.4.9-light-fixtures.json",
        ],
    }
