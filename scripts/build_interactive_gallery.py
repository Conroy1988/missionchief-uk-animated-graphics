...
RELEASES = [
    {
        "id": "v1.4.10",
        "label": "v1.4.10 · Current",
        "profile": "command",
        "summary": "Community First Responder roof-cross repair",
    },
    {
        "id": "v1.4.9",
        "label": "v1.4.9",
        "profile": "command",
        "summary": "OTL roof-mast repair",
    },
    {
        "id": "v1.4.8",
        "label": "v1.4.8",
    ...
    },
    {
        ...
        "label": "v1.4.6",
        "profile": "command",
        "summary": "ARV roof-light repair",
    },
    {
        "id": "v1.4.5",
        "label": "v1.4.5",
        "profile": "command",
        "summary": "RRV roof-light repair",
    },
    {
        "id": "v1.4.4",
        "label": "v1.4.4",
        "profile": "command",
        "summary": "IRV roof-light repair",
    },
    {
        "id": "v1.4.3",
        "label": "v1.4.3",
        "profile": "command",
        "summary": "Isolated point-lamp emergency lighting",
    },
    {
        "id": "v1.4.2",
        "label": "v1.4.2",
...
def build_catalogue() -> dict:
    ...
    build_report = load_json(ROOT / "data/v1.4.10-build-report.json")
    ...
    return {
        ...
        "generated_from": [
            ...
            "data/v1.4.10-build-report.json",
            "data/v1.4.10-scope.json",
            "data/v1.4.10-light-fixtures.json",
        ],
    }
